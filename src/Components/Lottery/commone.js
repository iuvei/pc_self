...
//同上，只是做整数限制
const checkIntWithdraw = ( obj,chineseid,maxnum ) => {
...
const checkemailWithdraw = ( obj,chineseid,maxnum ) => {
	obj.value = formatFloat(obj.value);
	if( parseFloat(obj.value) > parseFloat(maxnum) ){
