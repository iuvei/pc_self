...
export default class ContentMian extends Component {
    ...
    _inptu_deal(e) {
        ...
        switch (methodname) {
            ...
            case 'PK10ZX6':
                ...
                break;
            default:
                tmepS = tmepS.replace(/[\s\r,;，；　]/g, "|").replace(/(\|)+/g, "|");
                break;
        }
    ...
    addNum(param) {
        ...
        if (otype == 'input') {//如果是输入型，则检测号码合法性，以及是否存在重复号
            ...
            switch (mname) {//根据类型不同做不同检测
                ...
                case 'RXZXFFC3DS':
                case 'ZX3'  :
                    error = Method._inputCheck_Num(3, true);
                    break;
                //任三 直选 混合组选
                case 'RXZUWFC3HH' :
                case 'RXZUFFC3HH' :
                case 'RXZUSSC3HH' :
                case 'HHZX' :
                    error = Method._inputCheck_Num(3, true, Method._HHZXcheck, true);
                    break;
                //任选二-直选单式
                case "RXZXSSC2DS":
                case "RXZXWFC2DS":
                case "RXZXFFC2DS":
                case 'ZX2'  :
                    error = Method._inputCheck_Num(2, true);
                    break;
                //任选二组选单式
                case 'RXZUSSC2DS'  :
                case 'RXZUWFC2DS'  :
                case 'RXZUFFC2DS'  :
                case 'ZU2'  :
                    error = Method._inputCheck_Num(2, true, Method._HHZXcheck, true);
                    break;
                case 'ZX5'  :
                    error = Method._inputCheck_Num(5, true);
                    break;
                case 'ZX4'  :
                    error = Method._inputCheck_Num(4, true);
                    break;
                case 'ZUS'  :
                    error = Method._inputCheck_Num(3, true, Method._ZUSDScheck, true);
                    break;
                case 'ZUL'  :
                    error = Method._inputCheck_Num(3, true, Method._ZULDScheck, true);
                    break;
                case 'SDZX3':
                    error = Method._inputCheck_Num(8, true, Method._SDinputCheck, false);
                    break;
                case 'SDZU3':
                    error = Method._inputCheck_Num(8, true, Method._SDinputCheck, true);
                    break;
                case 'SDZX2':
                    error = Method._inputCheck_Num(5, true, Method._SDinputCheck, false);
                    break;
                case 'SDZU2':
                    error = Method._inputCheck_Num(5, true, Method._SDinputCheck, true);
                    break;
                case 'SDRX1':
                    error = Method._inputCheck_Num(2, true, Method._SDinputCheck, false);
                    break;
                case 'SDRX2':
                    error = Method._inputCheck_Num(5, true, Method._SDinputCheck, true);
                    break;
                case 'SDRX3':
                    ...
                    break;
                case 'SDRX4':
                    error = Method._inputCheck_Num(11, true, Method._SDinputCheck, true);
                    break;
                case 'SDRX5':
                    error = Method._inputCheck_Num(14, true, Method._SDinputCheck, true);
                    break;
                case 'SDRX6':
                    error = Method._inputCheck_Num(17, true, Method._SDinputCheck, true);
                    break;
                case 'SDRX7':
                    error = Method._inputCheck_Num(20, true, Method._SDinputCheck, true);
                    break;
                case 'SDRX8':
                    error = Method._inputCheck_Num(23, true, Method._SDinputCheck, true);
                    break;
                //任选四 直选 直选单式
                case "RXZXWFC4DS":
                case "RXZXFFC4DS":
    ...
    clearTraceNumber() {
        this.setState({checkAll: false}, () => {
            ...
            this.setState({
                checkselectItem: tempArray,
                traceItem: tempTraceItem,
                traceTotalMoney: 0,
                traceTotalIssue: 0
            });
        });
    ...
    enterLoading() {
        ...
        for (let i = 0; i < tempBets.length; i++) {
            tempTimes += tempBets[i]['money'] / tempBets[i]['times'];
        }
        if (this.state.traceTitleIndex == 0) {
            ...
            for (let i = 0; i < tempTraceItem.length; i++) {
                if (i < tempTotalIssue) {
                    ...
                    tempTraceItem[i].money = tempTraceItem[i].times * tempTimes;
                    tempData[i] = true;
        ...
        this.setState({
            checkselectItem: tempData,
            traceItem: tempTraceItem,
            checkAll: tempFlag,
            traceTotalMoney: tempMoney,
            traceTotalIssue: tempTime
        });
    };
        ...
        this.setState({checkAll: !this.state.checkAll}, () => {
            ...
            if (this.state.checkAll) {
                for (let i = 0; i < tempData.length; i++) {
                    if (!this.state.checkselectItem[i]) {
                        tempData[i].times = 1;
                        tempData[i].money = tempData[i].times * tempTimes;
                    }
                            ...
                            this.state.defaultposition.map((val, index) => {
                                return (
                                    <div className={val == 1 ? 'checkBox selected' : 'checkBox'} key={index}>
                                        <Checkbox defaultChecked={val == 1 ? true : false}
                                                  onChange={(e) => this.onChangeCheckBox(e, index, val)}>{wqbsgTemp[index]}</Checkbox>
                                    </div>
                                )
                            })
                        }</div>
                                ...
                                <div className="c_m_select_body_number" key={index}>
                                    ...
                                    <ul className="c_m_number_list">{
                                        val.no.split('|').map((vl, idx) => {
                                            return <li onClick={(e) => this.changeNum(e)} value={vl}
                                                       name={'lt_place_' + val.place} key={idx}>{vl}</li>
                                        })
                                    }
                                    </ul>
                                    {
                                                ...
                                                if (n.isButton == true) {
                                                    tempStr =
                                                        <div className="c_m_number_select right">
                                                            <button className='li' name='all'
                                                                    onClick={(e) => this.dxqqAction(otype, e)}>全
                                                            </button>
                                                            <button className='li' name='big'
                                                                    onClick={(e) => this.dxqqAction(otype, e)}>大
                                                            </button>
                                                            <button className='li' name='small'
                                                                    onClick={(e) => this.dxqqAction(otype, e)}>小
                                                            </button>
                                                            <button className='li' name='odd'
                                                                    onClick={(e) => this.dxqqAction(otype, e)}>奇
                                                            </button>
                                                            <button className='li' name='even'
                                                                    onClick={(e) => this.dxqqAction(otype, e)}>偶
                                                            </button>
                                                            <button className='li' name='clean'
                                                                    onClick={(e) => this.dxqqAction(otype, e)}>清
                                                            </button>
                                                        </div>
                                                }
                                            } else {
                                        ...
                                        (() => {
                                            if (this.state.hotSwitch) {
                                                ...
                                                if (stateVar.hotIndex == 1) {
                                                    switch (val.title) {
                                                        case "万位":
                                                            data = stateVar.missData.sWei.wan || []
                                                            break
                                                        case "千位":
                                                            data = stateVar.missData.sWei.qian || []
                                                            break
                                                        case "百位":
                                                            data = stateVar.missData.sWei.bai || []
                                                            break
                                                        case "十位":
                                                            data = stateVar.missData.sWei.shi || []
                                                            break
                                                        case "个位":
                                                            data = stateVar.missData.sWei.ge || []
                                                            break
                                                        case "第一位":
                                                            // 11选5 的返回值 顺序 需要重新排成 01 - 11
                                                            arr = Object.keys(stateVar.missData.sWei[1]).sort((pre, next) => {
                                                                return pre - next
                                                            })
                                                            data = arr.map((val) => {
                                                                return stateVar.missData.sWei[1][val]
                                                            })
                                                            break
                                                        case "第二位":
                                                            arr = Object.keys(stateVar.missData.sWei[2]).sort((pre, next) => {
                                                                return pre - next
                                                            })
                                                            data = arr.map((val) => {
                                                                return stateVar.missData.sWei[2][val]
                                                            })
                                                            break
                                                        case "第三位":
                                                            arr = Object.keys(stateVar.missData.sWei[3]).sort((pre, next) => {
                                                                return pre - next
                                                            })
                                                            data = arr.map((val) => {
                                                                return stateVar.missData.sWei[3][val]
                                                            })
                                                            break
                                                        case "第四位":
                                                            arr = Object.keys(stateVar.missData.sWei[4]).sort((pre, next) => {
                                                                return pre - next
                                                            })
                                                            data = arr.map((val) => {
                                                                return stateVar.missData.sWei[4][val]
                                                            })
                                                            break
                                                        case "第五位":
                                                            arr = Object.keys(stateVar.missData.sWei[5]).sort((pre, next) => {
                                                                return pre - next
                                                            })
                                                            data = arr.map((val) => {
                                                                return stateVar.missData.sWei[5][val]
                                                            })
                                                            break
                                                    }
                                                } else {
                                                    switch (val.title) {
                                                        case "万位":
                                                            data = stateVar.hotData.lre.wan || []
                                                            break
                                                        case "千位":
                                                            data = stateVar.hotData.lre.qian || []
                                                            break
                                                        case "百位":
                                                            data = stateVar.hotData.lre.bai || []
                                                            break
                                                        case "十位":
                                                            data = stateVar.hotData.lre.shi || []
                                                            break
                                                        case "个位":
                                                            data = stateVar.hotData.lre.ge || []
                                                            break
                                                        case "第一位":
                                                            arr = Object.keys(stateVar.hotData.lre[1]).sort((pre, next) => {
                                                                return pre - next
                                                            })
                                                            data = arr.map((val) => {
                                                                return stateVar.hotData.lre[1][val]
                                                            })
                                                            break
                                                        case "第二位":
                                                            arr = Object.keys(stateVar.hotData.lre[2]).sort((pre, next) => {
                                                                return pre - next
                                                            })
                                                            data = arr.map((val) => {
                                                                return stateVar.hotData.lre[2][val]
                                                            })
                                                            break
                                                        case "第三位":
                                                            arr = Object.keys(stateVar.hotData.lre[3]).sort((pre, next) => {
                                                                return pre - next
                                                            })
                                                            data = arr.map((val) => {
                                                                return stateVar.hotData.lre[3][val]
                                                            })
                                                            break
                                                        case "第四位":
                                                            arr = Object.keys(stateVar.hotData.lre[4]).sort((pre, next) => {
                                                                return pre - next
                                                            })
                                                            data = arr.map((val) => {
                                                                return stateVar.hotData.lre[4][val]
                                                            })
                                                            break
                                                        case "第五位":
                                                            arr = Object.keys(stateVar.hotData.lre[5]).sort((pre, next) => {
                                                                return pre - next
                                                            })
                                                            data = arr.map((val) => {
                                                                return stateVar.hotData.lre[5][val]
                                                            })
                                                            break
                                                    }
                            ...
                            return (
                                <div className="c_m_select_body_number" key={index}>
                                    ...
                                    <ul className="c_m_number_list">{
                                        val.no.split('|').map((vl, idx) => {
                                            return <li onClick={(e) => this.changeNum(e)} value={vl}
                                                       name={'lt_place_' + val.place} key={idx}>{vl}<p
                                                className="omit"></p></li>
                                        })
                                    }
                                    </ul>
                                    <div className="c_m_number_select right">
                                        <button className='li' name='all' onClick={(e) => this.dxqqAction(otype, e)}>全
                                        </button>
                                        <button className='li' name='clean'
                                                onClick={(e) => this.dxqqAction(otype, e)}>清
                                        </button>
                            ...
                            htmlStr = <div className='lh'>
                                <div className='wqbsg'>{
                                    pos_wei.map((value, index) => {
                                        return (
                                            <span className={this.checkwqbsg(index)} name={value}
                                                  onClick={(e) => this.clickLth(e, postData, true)}
                                                  key={index}>{wqbsg[value.split("")[0]] + wqbsg[value.split("")[1]]}</span>
                                        )
                                    })
                                }
                                </div>
                                <div className='lth'><p>{$('.wqbsg span.hover').html()}</p>
                                    {
                                        pos_lth.map((value, index) => {
                                            return (
                                                <span name={value} onClick={(e) => this.clickLth(e, postData)}
                                                      key={index}>{lth[value]}</span>
                                            )
                                        })
                                    }
                                </div>
                            ...
                            return (
                                <div className="c_m_select_body_number" key={index}>
                                    ...
                                    <ul className="c_m_number_list ddsdiv">{
                                        val.no.split('|').map((vl, idx) => {
                                            return <li className='dds' onClick={(e) => this.changeNum(e)} value={vl}
                                                       name={'lt_place_' + val.place} key={idx}>{vl}<p
                                                className="omit">1</p></li>
                                        })
                                    }
                                    </ul>
                                </div>)
                ...
                <div className="c_m_method_type clear">
                    ...
                    <ul className="c_m_method_details left">{
                        oneLotteryData[this.state.navIndex].label.map((value, idx) => {
                            return (
                                <li onClick={() => this.methodClick(0, idx, value)}
                                    className={this.check_tow_index(0, idx)} key={idx}>{value.gtitle}</li>
                            )
                        })
                    }</ul>
                </div>
                            ...
                            <ul className="c_m_method_details left">
                                {
                                    value.label.map((val, index) => {
                                        return (
                                            <li onClick={() => this.methodClick(idx, index)}
                                                className={this.check_tow_index(idx, index)} key={index}>{val.name}</li>
                                        )
                                    })
                                }
                            </ul>
    ...
    getnfprizeArea(a) {
        ...
        if (nfprize.length == 0) {
            ...
            tempHtml = <div className="c_m_bonus_ratio">
                <span>单注奖金</span>
                <Select value={this.state.omodel} style={{width: 100}} onChange={(value) => {
                    this.handleChangeRatio(value)
                }}>
    ...
    getHotMiss(flag) {
        if (!this.state.hotSwitch) {
            ...
            if (!flag) this.setState({hotSwitch: false})
        }
        ...
        return (
            <div>
                <div className='content_bet'>
                            ...
                            <ul className="c_m_nav_list left">
                                {
                                    oneLotteryData.map((element, index) => {
                                            ...
                                            return (
                                                <li className='renxuan' key={index}>
                                                    <div className="c_m_select">
                                                        <div
                                                            className="c_m_select_method_text">{element.title + '玩法'}</div>
                                        ...
                                        return (
                                            <li onClick={() => this.changeMethod(index)}
                                                className={this.check_nav_index(index)} key={index}>{element.title}</li>
                                        )
                                    })
                                }
                            </ul>
                        ...
                        <div className="c_m_controler">
                                            ...
                                            <div className="c_m_select_number">
                                                <div className="c_m_select_title">
				                                    ...
				                                    <Tooltip placement="bottomRight"
                                                             title={oneLotteryData.length == 0 ? '' : (oneLotteryData[this.state.navIndex].title == '龙虎庄闲' ? oneLotteryData[this.state.navIndex].label[this.state.navThreeIndex].label[this.state.navFourIndex].methodhelp : oneLotteryData[this.state.navIndex].label[this.state.navTwoIndex].label[this.state.navThreeIndex].methodhelp)}>
                            ...
                            <div className="c_m_select_operate">
                                <div className="c_m_select_operate_text">
                                    <span
                                        className="c_m_select_money">您选择了<strong>{this.state.numss}</strong>注，共<strong>{this.state.money.toFixed(2)}</strong>元</span>
                                    <span className="c_m_select_multiple">
	                                    <span>倍数：</span>
	                                    <img className="hvr-grow-shadow" onClick={() => {
                                            this.minusMultiple()
                                        }} src={minus_multiple} alt="减少倍数"/>
	                                   <AutoComplete
	                                    ...
	                                    <ul className="c_m_select_yjf right">
	                                        {
                                                this.state.modes.map((value, index) => {
                                                    return (
                                                        <li onClick={() => this.changeMode(index)}
                                                            className={this.state.selectYjf === index ? 'yjf_active' : ''}
				                                    ...
				                                    <span>未来期：</span>
                                                        {
                                                            (() => {
                                                                return (
                                                                    <span>
							                                        <Select value={stateVar.issueIndex}
                                                                            style={{width: 170}}
                                                                            onChange={(value) => this.handleChangeIssue(value)}>
				                                    					{
                                                                            stateVar.todayAndTomorrow.map((val, index) => {
                                                                                if (index == 0) {
                                                                                    return (
                                                                                        <Option key={index}
                                                                                                value={val.issue}>{val.issue}(当前期)</Option>
                                                                                    )
                                                                                } else {
                                                                                    ...
                                                                                    return (
                                                                                        <Option key={index}
                                                                                                value={val.issue}>{val.issue}</Option>
                                                                                    )
                                                                                }
                                                                            })
                                                                        }
                                    ...
                                    <Row>
                                                    ...
                                                    stateVar.BetContent.lt_same_code.length == 0 ? '选号区，请选择号码' : stateVar.BetContent.lt_same_code.map((value, index) => {
                                                        return (
                                                            <ul className="c_m_select_record_list clear" key={index}>
                                                                <li>{value.name}</li>
                                                                <li>{
                                                                    value.numberbet.length > 25 ?
                                                                        <Popover content={value.numberbet}>
                                                                            <div>{value.numberbet.substr(0, 25) + '...'}</div>
                                                                        </Popover> : value.numberbet
                                                                }</li>

                                                                <li className="c_m_cody_close"
                                                                    onClick={() => this.deleteBet(index)}><img
                                                                    src={close} alt=""/></li>
                                                                <li>{value.money + '元'}</li>
                                                                <li>{value.nums + '注'}</li>
                                                                <li>{value.times + '倍'}</li>
                                        ...
                                        <Col span={5}>
                                            <div className="c_m_machine_select">
                                                <Button className="c_m_machine_select_1" disabled={this.state.ifRandom}
                                                        onClick={() => this.setByRandom()}>机选一注</Button>
                                                <Button className="c_m_machine_select_5" disabled={this.state.ifRandom}
                                                        onClick={() => this.setByRandom(5)}>机选五注</Button>
                                                <div className="c_m_empty machine_active"
                                                     onClick={() => this.clearAllBet()}>清空号码
                                                </div>
                                            </div>
                                        </Col>
                                    </Row>
                                                        ...
                                                        <li className='c_m_select_multiple_div'>
                                                            <div className="">
				                                    			<span className="c_m_select_multiple">
								                                    <span>连续开奖：</span>
								                                    <img className="hvr-grow-shadow" onClick={() => {
                                                                        this.minusMmcMultiple()
                                                                    }} src={minus_multiple} alt="减少"/>
								                                    <input type="text"
                                                                           value={this.state.multipleMmcValue}
                                                                           onChange={this.multipleMmcValue.bind(this)}/>
								                                    <img className="hvr-grow-shadow" onClick={() => {
                                                                        this.addMmcMultiple()
                                                                    }} src={add_multiple} alt="增加"/>
								                                </span>
                                                                <Checkbox
                                                                    onChange={(e) => this.onChangeStop(e)}>中奖后停止</Checkbox>
                                                            </div>
                                                        </li>
                                                    )
                                                } else {
                                                    return (
                                                        <li style={{marginTop: '5px'}} className="c_m_superaddition">
                                                            <Button
                                                                disabled={stateVar.BetContent.lt_same_code == 0 ? true : false}
                                                                onClick={() => this.openTrace()}>我要追号</Button></li>
                                                    )
                                                }
                                            })()
                                        }
                                    ...
                                    >
                                        <div className="modal_main">
                                            <div className="m_m_content clear">
                                                <div
                                                    style={{display: this.state.traceTitleIndex == 0 ? 'block' : 'none'}}>
                                                        ...
                                                        <ul className="m_periods_list left">
                                                            {
                                                                periodsList.map((value, index) => {
                                                                    return <li key={index}
                                                                               className={this.state.periodsIndex === index ? 'm_periods_active' : ''}
                                                                               onClick={() => this.navTraceIssue(index, value)}>{value}</li>
                                                                })
                                                            }
                                                        </ul>
                                                    </div>
                                                    <div className="periods_input left">
                                                        <span>手动输入</span>
                                                        <InputNumber min={1} max={100} value={this.state.traceIssueNum}
                                                                     onChange={(value) => {
                                                                         this.onChangeInputTraceIssue(value)
                                                                     }}/>
                                                        <span>期</span>
                                                    </div>
                                                    <div className="multiple_input left">
                                                        <span>倍数</span>
                                                        <InputNumber min={1} max={9999} value={this.state.traceTimeNum}
                                                                     onChange={(value) => {
                                                                         this.onChangeInputTimeIssue(value)
                                                                     }}/>
                                                        <span>倍</span>
                                                    </div>
                                                    <Button type="primary" className="m_m_btn"
                                                ...
                                                <div
                                                    style={{display: this.state.traceTitleIndex == 2 ? 'block' : 'none'}}>
                                                    <div className="periods_input left">
                                                        <span>追号期数</span>
                                                        <InputNumber min={1} max={100} value={this.state.traceIssueNum}
                                                                     onChange={(value) => {
                                                    ...
                                                    <div className="periods_input left">
                                                        ...
                                                        <InputNumber min={1} max={100}
                                                                     value={this.state.traceLowMoneyNum}
                                                                     onChange={(value) => {
                                                                         this.onChangeLowMoney(value)
                                                                     }}/>
                                                        <span>%</span>
                                                    </div>
                                                    <Button type="primary" className="m_m_btn"
                                                ...
                                                <div
                                                    style={{display: this.state.traceTitleIndex == 1 ? 'block' : 'none'}}>
                                                    <div className="multiple_input left">
                                                        <span>追号期数</span>
                                                        <InputNumber min={1} max={100} value={this.state.traceIssueNum}
                                                                     onChange={(value) => {
                                                    ...
                                                    <div className="periods_input left">
                                                        <span>隔</span>
                                                        <InputNumber min={1} value={this.state.traceIssueSpaceNum}
                                                                     onChange={(value) => {
                                                                         this.onChangeInputSpaceTraceIssue(value)
                                                                     }}/>
                                                        <span>期</span>
                                                    </div>
                                                    <div className="periods_input periods_inputlv left">
                                                        ...
                                                        <InputNumber min={1} max={9999}
                                                                     value={this.state.traceTimeSpaceNum}
                                                                     onChange={(value) => {
                                                                         this.onChangeInputSpaceTimeIssue(value)
                                                                     }}/>
                                                        <span>倍</span>
                                                    </div>
                                                    <Button type="primary" className="m_m_btn"
                                            ...
                                            <div className="m_m_table">
                                                <div className='thClass'>
                                                    ...
                                                    <div style={{width: '20%'}}><Checkbox
                                                        onChange={(e) => this.onCheckAllChange(e)}
                                                        checked={this.state.checkAll}>期数</Checkbox></div>
                                                            ...
                                                            mobx.toJS(this.state.traceItem).map((val, index) => {
                                                                return (
                                                                    <tr key={index}>
                                                                        ...
                                                                        <td style={{width: '20%'}}><Checkbox
                                                                            onChange={(e) => {
                                                                                this.selectItem(index, e)
                                                                            }}
                                                                            checked={this.state.checkselectItem[index]}>{val.age}</Checkbox>
                                                                        </td>
                                                                        <td style={{width: '25%'}}><InputNumber min={0}
                                                                                                                disabled={!this.state.checkselectItem[index]}
                                                                                                                max={9999}
                                                                                                                value={val.times}
                                                                                                                onChange={(value) => {
                                                                                                                    this.traceInput(index, value)
                                                                                                                }}/>&nbsp;倍
                                                                        </td>
                                                                        <td style={{
                                                                            width: '15%',
                                                                            color: '#cb1414'
                                                                        }}>{val.money.toFixed(4)}元
                                                                        </td>
                                            ...
                                            <div className="m_m_footer clear">
                                                <div className="m_m_left_btn left">
                                                    <Checkbox checked={this.state.traceifStop}
                                                              onChange={(e) => this.onChangeTraceStop(e)}>中奖后停止追号</Checkbox>
                                                    <Button type="primary"
                                                            onClick={() => this.clearTraceNumber()}>清空号码</Button>
                                                </div>
                    ...
                    <AlterModal historyBet={this.getBetHistory} lotteryOkBet={this.lotteryOkBet}
                                betData={this.state.betokObj}/>
                </div>
            </div>
        );
    }
