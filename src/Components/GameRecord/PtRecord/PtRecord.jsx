                ...
                <div className="team_list_top">
                    <div className="t_l_time">
                        ...
                        <ul className="t_l_classify">
                            ...
                            <li>
                                <span>游戏名称：</span>
                                <Select value={postData.gameid} style={{ minWidth: 125 }} onChange={(value)=>{this.handleChangeMethod(value)}}>
                            ...
                            <li>
                                <span>状态：</span>
                                <Select value={postData.status} style={{ minWidth: 80 }} onChange={(value)=>{this.handleChangeStatus(value)}}>
                            ...
                            <li>
                                <span>用户名：</span>
                                <Input placeholder="请输入用户名" value={postData.username} onChange={(e)=>this.onUserName(e)}/>
                            </li>
                            <li>
