                ...
                <div className="team_list_top">
                    <div className="t_l_time">
                        <ul className="t_l_time_row">
                                ...
                                <ul className="t_l_time_btn clear">
                                    {
                                        shortcutTime.map((item,i)=>{
                                            return <li className={item.id === this.state.postData.threeSeven ? 't_l_time_btn_active' : ''} onClick={()=>{this.onShortcutTime(item.id)}} key={item.id}>{item.text}</li>
                                        })
                                    }
                                </ul>
                            </li>
                            <li>
                                <span>用户名：</span>
                                <Input placeholder="请输入用户名" value={this.state.postData.username} style={{width: 180}} onChange={(e)=>this.onUserName(e)}/>
                            </li>
                            <li>
                        ...
                        <ul className="t_l_classify">
                            ...
                            <li>
                                <span>玩法群：</span>
                                <Select value={this.state.crowdid} style={{ minWidth: 90 }} onChange={(value)=>this.setState({crowdid: value})}>
                                    <Option value="-1">所有玩法群</Option>
                                    {
                                        ...
                                        responseData.newCrowdList[postData.lotteryid].map((item,i)=>{
                                            return <Option value={item.crowdid} key={item.crowdid}>{item.crowdname}</Option>
                                        }) : ''
                                    }
                                </Select>
                            </li>
                            ...
                            <li>
                                <span>投注模式：</span>
                                <Select defaultValue="0" style={{ minWidth: 80 }} onChange={(value)=>{this.handleBetPattern(value)}}>
                            ...
                            <li>
                                <span>状态：</span>
                                <Select defaultValue="0" style={{ minWidth: 80 }} onChange={(value)=>{this.handleStatus(value)}}>
                                    <Option value="0">所有</Option>
