        ...
        const columns = [
            {
                ...
                render: (text, record, index) => (
                    text ?
                        index == 0 ?
                            text :
                            <span className="hover_a"
                                  onClick={() => this.onClickTable('USERNAME', record)}>{text}</span> :
                        userName
                ),
                width: 120,
            }, {
                ...
                <div className="team_list_top">
                    <div className="t_l_time" onKeyDown={(e) => this.onKeyDown(e)}>
                        ...
                        <ul className="t_l_classify">
                            <li>
                                <span>游戏分类：</span>
                                <span className={this.variety_index(1)} onClick={() => {
                                    this.setState({variety: 1})
                                }}>彩票</span>
                            </li>
                            <li>
                                <span>游戏种类：</span>
                    ...
                    <div
                        className={this.state.showLottery ? 't_m_select_lottery t_m_select_lottery_show clear' : 't_m_select_lottery clear'}>
                        <Checkbox
                        ...
                        >
                            {
                                lotteryList.map((item, i) => {
                                    return <Checkbox value={item.lotteryid}
                                                     key={item.lotteryid}>{item.cnname}</Checkbox>
                                })
                            }
                        </Checkbox.Group>
                    </div>
